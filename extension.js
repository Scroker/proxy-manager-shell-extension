...
class ProxyMenuToggle extends QuickSettings.QuickMenuToggle {
    _init(extensionObject) {
        ...
        this._itemsSection.addAction(_('Proxy one'), () => console.debug('Menu item 1 selected!')).setOrnament(PopupMenu.Ornament.DOT);
        this._itemsSection.addAction(_('Proxy two'), () => console.debug('Menu item 2 selected!')).setOrnament(PopupMenu.Ornament.NONE);
